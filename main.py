...
# env
bot_token = os.environ.get("TOKEN", "7691874010:AAG1n-yRnq0OdEs78NHFckWlBc7JZDKZFpo") 
api_hash = os.environ.get("HASH", "df50c6b4d54715a922027b76884fb1d6") 
api_id = os.environ.get("ID", "25515908")
